...
#define OPENSSLGENERICTHROWIFTRUE(x) x ? throw std::runtime_error((boost::format("%1% in %3% (%4%:%5%) because %6%") % #x % "" % __FUNCTION__ % __FILE__ % __LINE__ % ERR_error_string(ERR_get_error(), nullptr)).str()) : 0
